...
public class SampleStreamKeno extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sample_stream_keno);
      ...
      /* ScalableVideoView mVideoView = (ScalableVideoView) findViewById(R.id.video_view);
        ...
        */
        ...
        sample1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ProgressDialog.Builder dialog = new ProgressDialog.Builder(SampleStreamKeno.this);
                ...
                dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(SampleStreamKeno.this,ChatInStream.class);
        ...
        videoView.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.smixxitkeno));
        videoView.start();
