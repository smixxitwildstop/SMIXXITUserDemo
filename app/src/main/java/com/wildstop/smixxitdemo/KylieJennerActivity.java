...
public class KylieJennerActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.kylie_jenner);
       ...
       */
        ...
        mFloatingtoolbarProfile.setClickListener(new FloatingToolbar.ItemClickListener() {
            ...
            public void onItemClick(MenuItem item) {
                ...
                if (id==R.id.earn){
                    Intent intent = new Intent(KylieJennerActivity.this, EarnPoints.class);
                    startActivity(intent);
                }
                if (id==R.id.discover){
                    Intent intent = new Intent(KylieJennerActivity.this,ExploreScreen.class);
                    startActivity(intent);
                }
                if (id==R.id.profile){
                    Intent intent = new Intent(KylieJennerActivity.this,ProfileList.class);
                    startActivity(intent);
                }
                if (id==R.id.navback){
                    return;
                ...
                if (id==R.id.home){
                    Intent intent= new Intent(KylieJennerActivity.this,Home.class);
                    startActivity(intent);
                }
            }
        ...
        CountDownTimer timer = new CountDownTimer(20000, 1000) {
            ...
            public void onFinish() {
                Toast.makeText(KylieJennerActivity.this, "Begin The Test Steam", Toast.LENGTH_SHORT).show();
        ...
        joinStreamButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(KylieJennerActivity.this,SampleStream.class);
                startActivity(intent);
            }
        });
